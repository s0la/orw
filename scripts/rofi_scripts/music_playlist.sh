...
[[ $1 == h* ]] &&
	width='window' lines=6 orientation=horizontal ||
	width='art' lines=6 orientation=vertical
...
theme_str="cover-art { padding: @art-${orientation}-padding; } "
theme_str+="window { orientation: $orientation; width: @${width}-width; } "
theme_str+="list { margin: @list-${orientation}-margin; } "
